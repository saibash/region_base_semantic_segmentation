...
#    train_names = ['bildstein_station1', 'bildstein_station5', 'domfountain_station1', 'domfountain_station3',
# 'neugasse_station1', 'sg27_station1', 'sg27_station2', 'sg27_station5', 'sg27_station9', 'sg28_station4', 'untermaederbrunnen_station1']
    #valid_names = ['bildstein_station3', 'domfountain_station2', 'sg27_station4', 'untermaederbrunnen_station3']

    train_names = ['bildstein_station5', 'sg27_station9']
    valid_names = ['bildstein_station3', 'domfountain_station2', 'sg27_station4']
...
def preprocess_pointclouds(SEMA3D_PATH, areas):
    """ Preprocesses data by splitting them by components and normalizing."""

    #for n in ['train', 'test_reduced', 'test_full']:
    for n in areas:#, "Building_3/Generic"]:
    #+for n in ['validation/DEM']:
        n = n + "/Generic"
        ...
        for file in os.listdir(pathC):
            ...
            try:
              if file.endswith(".h5"):
                ...
                #dem = f['dem'][:].astype(np.float)
                elpsv = np.stack([ f['dem'][:, 3][:], f['linearity'][:], f['planarity'][:], f['scattering'][:], f['verticality'][:] ], axis=1)
...
#     parser.add_argument('--SEMA3D_PATH', default='/home/cont_jh/Data/stanford')#'/home/cont_jh/Data/semantic3d')
